"""
Viable solver for diffraction off. 
Good for running 1D runs in parallel to sweep results of altering sigma, intensity, etc.
...
#Integrator Function -----------------------------------------------------------------
def diffraction_off(times_to_save=times_to_save):
    """
    ...
    b_prev[:, :] = b0 * zeta_gaussian[:, None] * radial_gaussian[None, :] * phase_term[None, :]
