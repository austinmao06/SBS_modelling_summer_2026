#returns minimum length over which 80% of total seed energy is contained at each time
...
dur = pulse_duration()
t = np.argmin(np.abs(tau - 126.7e-9))
print(f"The seed is {dur[t]}m long after 126.7ns")
